...
func TestGetEntitlementCertificate(t *testing.T) {
	...
	entCertKeys, err := rhsmClient.getSCAEntitlementCertificates(nil)
	if err != nil {
...
func TestGetEntitlementCertificateWrongConsumerUUID(t *testing.T) {
	...
	_, err = rhsmClient.getSCAEntitlementCertificates(nil)
	if err == nil {
...
{
  "contentListing" : {
    "8713004171067776439" : [ "-----BEGIN CERTIFICATE-----\\nV5tHMk9HNUM3bTvUu8hjLAo3axYLVMJm\n-----END CERTIFICATE-----\n",
"-----BEGIN ENTITLEMENT DATA-----\\n-----END ENTITLEMENT DATA-----\n-----BEGIN SIGNATURE-----\\n-----END SIGNATURE-----\n" ]
  },
...
// TestGetEntitlementCertificate test the case, when it is possible to get SCA
// certificate and key from the server
func TestUpdateEntitlementCertificate(t *testing.T) {
	t.Parallel()
	var expectedClientUUID = "5e9745d5-624d-4af1-916e-2c17df4eb4e8"
	handlerCounter := 0
	...
	// Test that entitlement cert is installed
	expectedEntCertFilePath := filepath.Join(testingFiles.EntitlementDirPath, "8713004171067776439.pem")
	if _, err := os.Stat(expectedEntCertFilePath); err != nil {
		t.Fatalf("expected entitlement cert: %s is not installed: %s", expectedEntCertFilePath, err)
	}
	...
	if err != nil {
		t.Fatalf("unable to read content of: %s: %s", expectedEntCertFilePath, err)
	}
	if !strings.Contains(string(entCertContent), "-----BEGIN CERTIFICATE-----") {
		t.Fatalf("entitlement cert: %s does not contain all required blocks", expectedEntCertFilePath)
	}
	if !strings.Contains(string(entCertContent), "-----BEGIN ENTITLEMENT DATA-----") {
		t.Fatalf("entitlement cert: %s does not contain all required blocks", expectedEntCertFilePath)
	}
	if !strings.Contains(string(entCertContent), "-----BEGIN SIGNATURE-----") {
		t.Fatalf("entitlement cert: %s does not contain all required blocks", expectedEntCertFilePath)
	}
